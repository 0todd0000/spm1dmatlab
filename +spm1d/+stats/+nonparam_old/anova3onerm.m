...
if isvector(y)
    perm  = spm1d.stats.nonparam_old.permuters.PermuterANOVA3onerm_0D(y, A, B, C, SUBJ);
else
    perm  = spm1d.stats.nonparam_old.permuters.PermuterANOVA3onerm_1D(y, A, B, C, SUBJ);
end
