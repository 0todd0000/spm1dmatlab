...
alpha     = 0.05;
ci0       = spm1d.stats.ci_twosample(yA, yB, alpha, 'difference', 0);
ci1       = spm1d.stats.ci_twosample(yA, yB, alpha, 'meanA', 'meanB');
ci2       = spm1d.stats.ci_twosample(yA, yB, alpha, 'meanA', 'tailB');
disp(ci0)
disp(ci1)
disp(ci2)
...
subplot(232)
spmi  = spm1d.stats.ttest2(yA, yB).inference(alpha);
spmi.plot();
